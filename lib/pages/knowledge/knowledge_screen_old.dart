...
class KnowledgeScreenOld extends ConsumerStatefulWidget {
  const KnowledgeScreenOld({super.key});

  @override
  _KnowledgeScreenState createState() => _KnowledgeScreenState();
}

class _KnowledgeScreenState extends ConsumerState<KnowledgeScreenOld> with CategoryMixin {
  ...
  Widget build(BuildContext context) {
    ...
    List<Article> knowledges = ref.watch(knowledgesProvider).value ?? [];
   ...
   */
  Widget _buildKnowItem(Article item) {
